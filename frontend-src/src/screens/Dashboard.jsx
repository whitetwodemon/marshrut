...
function Dashboard({ data, tasks, scanLog, lang, onScan, onCloseTask, onNewOrder, onPauseTask, onResumeTask }) {
...
function DetailBoardGroup({ detail, tasks, done, total, qty, lang, onCloseTask, onPauseTask, onResumeTask }) {
  const S = useStrings(lang);
...
export { Dashboard, DetailBoardGroup }
