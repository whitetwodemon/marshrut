...
class WorkCentersController
{
    ...
    public static function nextOrderNumber(array $params): void
    {
        ...
        try {
            ...
            // Номер = max из реальных заказов + 1
            // НЕ сохраняем счётчик здесь — только при реальном создании заказа
            // Это предотвращает "прыжки" номеров при открытии формы
            $nextSeq = $maxFromOrders + 1;
