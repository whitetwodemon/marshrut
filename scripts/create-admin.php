...
// ── Создаём тестовых пользователей только если разрешено ────────────────
// Для perimetr (продакшн) CREATE_TEST_USERS не задан — пользователи не создаются
if (!getenv('CREATE_TEST_USERS')) {
    echo "[create-admin] ✓ Skipping test users (set CREATE_TEST_USERS=1 to enable)\n";
    exit(0);
}
